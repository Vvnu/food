...
if(!$con)
{
   ...
   if(isset($_SESSION['email'])){
     ...
     $sql="select username,phone,address,email,pfp from userdata where email= '$validUser' ";
     $res=mysqli_query($con,$sql);
    
      $register=mysqli_fetch_assoc($res);
      echo  '<b>username:</b> <div class="profile-name">' . $register['username'] . '</div>';
      echo "<img class='pic' src='".$register['pfp']."'><br> <br>";
        ...
        echo '<a href="logout.php"><button type = "submit"> Logout</button></a>';
  }
  else{
